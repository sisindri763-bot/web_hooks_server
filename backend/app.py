...
@app.route("/api/dashboard/observability-details", methods=["GET"])
def api_dashboard_observability_details():
    details = get_observability_details()
    return jsonify(details), 200


@app.route("/api/dashboard/quality-details", methods=["GET"])
